...
@section('content')
    ...
    <div class="container max-w-[1250px]  mx-auto px-4 flex flex-col justify-between h-full">
        <div class="relative grid grid-flow-row md:grid-flow-col">
            <div class="block">
                <div class="text-justify text-zinc-700 text-[35px] font-black uppercase tracking-widest">НОВОСТИ</div>
                <div class="left-[2px] top-[68px]">
                    <div class="border-t border-b py-4 border-black">
                        ...
                        <div class="text-zinc-700 text-[22px] font-semibold leading-loose">Поздравление с международным женским днём матерей мобилизованных</div>
                    ...
                    <div class="border-b border-t py-4 border-black">
                        ...
                        <div class="text-zinc-700 text-[22px] font-semibold leading-loose">Завершился финал Республиканского этапа Всероссийских соревнований «Золотая шайба»</div>
    ...
    <div class="container max-w-[1250px] mt-20 mx-auto px-4 flex flex-col justify-between h-full">
        ...
        <div class="flex lg:flex-row flex-col items-center justify-between">
            ...
            <div class="w-[360px] mt-4 lg:mt-0 bg-cover bg-center">
                <div class="h-[225px] bg-[#c1c1c1]"></div>
            </div>
            <div class="w-[360px] mt-4 lg:mt-0 bg-cover bg-center">
                <div class="h-[225px] bg-[#c1c1c1]"></div>
