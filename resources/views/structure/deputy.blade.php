...
@section('title', 'Республиканское общественное движение &quot;Татарстан - новый век&quot; - депутаты от Движения "ТНВ" в органах местного самоуправления')
@section('content')
    <div class="container max-w-[1250px] mt-8 mx-auto px-4 flex flex-col justify-between ">
        <div class="grid grid-flow-row xl:grid-flow-col justify-start items-start gap-[15px]">
            ...
            <div class="grid grid-flow-col justify-start items-center gap-4">
                <a href="/structure/deputy" class="opacity-60 text-left text-neutral-600 text-[14px] font-normal">Депутаты от Движения "ТНВ" в органах...</a>
            </div>
        </div>
    </div>
    <div class="container max-w-[1250px] mt-8 mx-auto px-4 grid grid-flow-row gap-10">
        <div class="text-zinc-700 text-xl md:text-3xl font-black uppercase">Депутаты от Движения "ТНВ" в органах местного самоуправления</div>
        123
    </div>
@endsection
