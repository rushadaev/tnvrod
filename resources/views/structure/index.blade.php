...
@section('content')
    ...
    $pages = collect([
        [
            "title" => "Высший совет",
            "link" => "/structure/council"
        ],
        [
            "title" => "Президиум",
            "link" => "/structure/presidium"
        ],
        [
            "title" => "Исполком Высшего Совета",
            "link" => "/structure/executive"
        ],
        [
            "title" => "Депутатская группа «ТНВ» VI созыва в Государственном Совете Республики Татарстан",
            "link" => "/structure/deputy-group"
        ],
        [
            "title" => "Председатели советов территориальных отделений",
            "link" => "/structure/chairman"
        ],
        [
            "title" => "Зональные координационные советы",
            "link" => "/structure/zonal"
        ],
        [
            "title" => "Депутаты от Движения «ТНВ» в органах местного самоуправления",
            "link" => "/structure/deputy"
        ],
        [
            "title" => "Коллективные Участники",
            "link" => "/structure/participants"
        ],
        [
            "title" => "Молодежные лидеры территориальных отделений",
            "link" => "/structure/youth-leaders"
        ]
        ]);
    @endphp
