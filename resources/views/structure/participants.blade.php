...
@section('title', 'Республиканское общественное движение &quot;Татарстан - новый век&quot; - Коллективные Участники Движения ТНВ')
@section('content')
    <div class="container max-w-[1250px] mt-8 mx-auto px-4 flex flex-col justify-between ">
        <div class="grid grid-flow-row xl:grid-flow-col justify-start items-start gap-[15px]">
            ...
            <div class="grid grid-flow-col justify-start items-center gap-4">
                <a href="/structure/participants" class="opacity-60 text-left text-neutral-600 text-[14px] font-normal">Коллективные Участники Движения ТНВ</a>
            </div>
        </div>
    </div>
